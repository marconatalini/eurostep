...
//    public static String SERVER_PORT  = "server_port";
    ...
    public static String SHOW_CORNICI = "show_cornici";
    public static String SHOW_PEZZI = "show_spezzoni";
    public static String SHOW_DATAORA = "show_datetime";
    ...
    protected boolean isValidFragment(String fragmentName) {
        return PreferenceFragment.class.getName().equals(fragmentName)
                ...
                || ListaOrdiniPreferenceFragment.class.getName().equals(fragmentName);
    }
...
//            bindPreferenceSummaryToBooleanValue(findPreference("use_volley"));
    ...
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class ListaOrdiniPreferenceFragment extends PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.pref_lista_ordini);
            setHasOptionsMenu(true);
            ...
            // updated to reflect the new value, per the Android Design
            // guidelines.
            bindPreferenceSummaryToBooleanValue(findPreference("show_finitura"));
            bindPreferenceSummaryToBooleanValue(findPreference("show_cornici"));
            bindPreferenceSummaryToBooleanValue(findPreference("show_spezzoni"));
            bindPreferenceSummaryToBooleanValue(findPreference("show_datetime"));
        }
